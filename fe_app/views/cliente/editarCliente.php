...
<div class="controller" ng-controller="editarClienteController">
	<form id="editarCliente" class="form-validation" method="post" name="editarCliente">
		<div id="headerbar">
	        <h1 class="headerbar-title">Editar cliente</h1>
	                    ...
	                    <div class="panel-body">
	                    	<div class="form-group">
	                    		...
	                    		<select class="form-control" name="tipo_cliente" id="tipo_cliente" ng-model="tipo_cliente" ng-change="cambio()" aria-describedby="tigoGastoHelp">
	                    			<?php 
	                    			 if(isset($person_types)){
	                    				foreach ($person_types as $key => $value) { 
		                    				$selected = '';
		                    				if(isset($cliente->personType_id)){
		                    					if($cliente->personType_id==$value->person_type_id){
		                    						$selected = 'selected="selected"';
		                    					}
		                    				}

		                    				?>
	                    						<option value="<?=$value->person_type_id?>" ng-value="<?=$value->person_type_id?>" <?=$selected?>><?=$value->person_description?></option>
	                    	...
	                    	<div class="form-group" ng-if="tipo_cliente==2">
								...
								<input type="text" name="nombre_cliente" class="form-control input-required" id="nombre" aria-describedby="nombreHelp"  value="<?=(isset($cliente->firstName))?$cliente->firstName:''?>">
							...
							<div class="form-group" ng-if="tipo_cliente==1">
								...
								<input type="text" name="segundo_nombre_cliente" class="form-control" id="nombre" aria-describedby="segnombreHelp"  value="<?=(isset($cliente->secondName))?$cliente->secondName:''?>">
							...
							<div class="form-group" ng-if="tipo_cliente==1">
								...
								<input type="text" name="apellido_cliente" class="form-control" id="nombre" aria-describedby="apellidoHelp"  value="<?=(isset($cliente->lastName))?$cliente->lastName:''?>">
							...
							<div class="form-group">
								...
								<input type="text" name="cedula_cliente" class="form-control input-required" id="cedula" aria-describedby="cedulaHelp" value="<?=(isset($cliente->identificacion))?$cliente->identificacion:''?>">
							...
							<div class="px-3 mb-3 border border-top-0 border-left-0 border-right-0 row group-template" ng-repeat="(x,address) in addresses">
								...
								<div class="col-10 col-md-11">
									...
									<div class="form-group address-group row">
					            		...
					            		<div class="col-xs-6" ng-if="address.address_country!=='CR'">
